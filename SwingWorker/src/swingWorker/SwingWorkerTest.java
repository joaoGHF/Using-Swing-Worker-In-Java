 ...
 * time-consuming task. Reference to the book Core Java I in Listing 14.14, by
 * Cay Horstmann.
 *
 */
...
class SwingWorkerFrame extends JFrame {
	...
	public static final int TEXT_COLLUMNS = 60;

	public SwingWorkerFrame() {
		chooser = new JFileChooser();
		chooser.setCurrentDirectory(new File("."));

		textArea = new JTextArea(TEXT_ROWS, TEXT_COLLUMNS);
	...
	private class TextReader extends SwingWorker<StringBuilder, ProgressData> {
		...
		/**
		 * The following method executes in the worker thread; it doesn't touch Swing
		 * Components
		 */
		@Override
